# Installation
> `npm install --save @types/umami-browser`

# Summary
This package contains type definitions for umami-browser (https://github.com/umami-software/umami).

# Details
Files were exported from https://github.com/DefinitelyTyped/DefinitelyTyped/tree/master/types/umami-browser.
## [index.d.ts](https://github.com/DefinitelyTyped/DefinitelyTyped/tree/master/types/umami-browser/index.d.ts)
````ts
...
### Additional Details
 * Last updated: Wed, 03 Sep 2025 11:02:39 GMT
 * Dependencies: none
